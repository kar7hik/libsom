...
class Neuron_Creator():
    ...
    def zero_neuron(self, input_dataset, level):
        self.level = level
...
class GHSOM():
    ...
    def create_som_zero_neuron(self, level=0):
...
#     print(result_list[min_mean].get('weight_map'))
#     get_specified_map(zero_neuron, level, location, result)

#     return np.asarray(result[0])


# m, r = find_best_matching_map(zero_neuron, test_check)
# map_result = get_best_map(zero_neuron, test_check)
# plot_rgb_data(test_check)
